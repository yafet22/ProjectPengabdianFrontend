  ...
  <div style="width: -moz-available;">
    <v-flex xs12 md12 lg12 xl3>
        ...
        <v-card-text style="padding:24px">
            ...
            <v-btn tile block small color="#FFFFFF" style="height:40px;color:#01305E;margin-top:32px" class="elevation-0">
                Input Data Baru
            </v-btn>
        </v-card-text>
        </div>
    ...
    <div style="margin-top:20px">
        ...
        <div v-for="(owner) in owners" :key="owner.id">
          <v-list-item >
            ...
            <v-list-item-action>
            <v-btn tile small color="#F6B931" style="width:60px;height:20px;font-size:7px" dark class="elevation-0">DETAIL</v-btn>
            </v-list-item-action>
          </v-list-item>
